$(document).ready(function() {
    ...
    if ($('.cube').length > 0) {
        ...
        $('body').on('click', '.face-1-chart-year a, .face-1-chart-point.active', function(e) {
            ...
            windowHTML      +=      '<div class="window-face1-title">Топ-10 стран по количеству заявок на патенты за&nbsp;' + curYear + ' год, ед.</div>';
                ...
                $('body').append('<div class="map-window"><div class="map-window-inner">' +
                                        ...
                                        '<div class="map-window-info">' +
                                            '<div class="map-window-info-item">' +
                                                '<div class="map-window-info-item-title">Число заявок<br /> на патенты</div>' +
                                                '<div class="map-window-info-item-value map-window-info-item-value-1"></div>' +
                                            '</div>' +
                                            '<div class="map-window-info-item">' +
                                                '<div class="map-window-info-item-title">Число заявок на патенты<br /> на 100 исследователей</div>' +
                                                '<div class="map-window-info-item-value map-window-info-item-value-2"></div>' +
                                            '</div>' +
                                        '</div>' +
                                        '<div class="map-window-info-chart-title">Фактическое и прогнозное<br /> число заявок на патенты, ед.</div>' +
            ...
            if ($('.map-window').length == 0) {
                $('body').append('<div class="map-window"><div class="map-window-inner">' +
                                        ...
                                        '<div class="map-window-info">' +
                                            ...
                                            '</div>' +
                                        '</div>' +
                                        '<div class="map-window-info-chart-title">Фактическое и прогнозное<br /> число заявок на патенты, тыс. ед.</div>' +
                                        '<div class="map-window-info-chart"></div>' +
                                        '<div class="map-window-info-link"><a href="#" class="btn-med" data-id="">Перейти на карту ФО</a></div>' +
                                     '</div></div>');
            }
