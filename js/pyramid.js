$(function(){
    ...
    var mouse = {
        ...
        viewport = {
            ...
            move: function(coords) {
                ...
                this.el.style[transformProp] = "rotateX("+this.x+"deg) rotateY("+this.y+"deg) rotateZ(-90deg)";
            },
            reset: function() {
                this.move({x: 0, y: 0});
            }
    ...
    $(document).keydown(function(evt) {
        ...
        $(document).bind('mousemove touchmove', function(event) {
            ...
            if(!touch || !(event.originalEvent && event.originalEvent.touches.length > 1)) {
                ...
                $('.pyramid').trigger('move-viewport', {x: event.pageX, y: event.pageY});
            }
        });
    ...
    $('.pyramid').bind('move-viewport', function(evt, movedMouse) {
